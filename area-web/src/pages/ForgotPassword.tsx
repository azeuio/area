        ...
        <div className='h-screen flex flex-col'>
            ...
            <div className="flex flex-col items-center flex-grow justify-center">
                <div className='space-y-10 flex flex-col items-center justify-center'>
                    <p className="text-center text-7xl font-SpaceGrotesk">Forgot your password ?</p>
                    <p className="text-center w-4/5 text-[#8E8E93] text-2xl font-SpaceGrotesk">Enter your email below to receive an email to reset your password</p>
                    ...
                    <CTA buttonText='Send email' buttonStyle='bg-[#34A853] text-white text-5xl px-14' onClick={handlePasswordReset}/>
                </div>
            </div>

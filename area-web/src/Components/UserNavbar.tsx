            ...
            <div className='py-7 pl-11 flex items-center justify-between'>
                ...
                <div className='pr-11 flex items-center justify-between space-x-14'>
                    <a href={this.props.boardsLink}>
                        <button className={`text-4xl font-SpaceGrotesk hover:underline ${this.props.isBoards ? 'underline' : ''}`}>Boards</button>
                    </a>
                    <a href={this.props.areasLink}>
                        <button className={`text-4xl font-SpaceGrotesk hover:underline  ${this.props.isAreas ? 'underline' : ''}`}>Areas</button>
                    </a>
